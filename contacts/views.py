...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have alreday made in inquiry about this car. Please wait until we get back to you.')
        ...
        send_mail(
            ...
            'dnp17620@gmail.com', #From Email Address
            ['dnp17620@gmail.com'], #To Email Address
            fail_silently=False,
        )
        contact.save()
